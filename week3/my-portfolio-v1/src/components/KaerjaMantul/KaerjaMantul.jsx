...
const KaerjaMantulContainer    = styled.div`
...
const KaerjaMantul = () => {
  ...
  return (
    <KaerjaMantulContainer theme={theme}>
        <ImgWrapper theme={theme}>
          <ArrowShape>
            <AiOutlineArrowsAlt />
          </ArrowShape>
          <img src="src/assets/imgKaerjaMantul.png" alt="img" width={556} height={282}/>
        </ImgWrapper>
        <TxtWrapper theme={theme}>
          <SubP theme={theme}>Web Development</SubP>
          <h3>Kerja Mantul Education Management</h3>
    ...
    </KaerjaMantulContainer>
  )
};

export default KaerjaMantul