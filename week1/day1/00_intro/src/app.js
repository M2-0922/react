...
// code here 
const pTagText = "Nulla amet fugiat nostrud sint nulla aute est. ";

const landingPage1 = React.createElement("div", {className: "container"},
    React.createElement("nav", null,
        React.createElement("ul", null,
            React.createElement("li", null,
                React.createElement("h3", "LOGO")
            ),
            React.createElement("li", null,
    ...
    React.createElement("main", null,
        ...
        React.createElement("section", {id: "article"},
            React.createElement("article", null,
                ...
                React.createElement("p", null, pTagText)
            ),
            React.createElement("article", null,
