...
const MylandingPage = React.createElement(
    "div",
    ...
    React.createElement("main", null,
        React.createElement("section", null,
            React.createElement("h1", { id: "title" }, null, "Hello World",
            ),
            React.createElement("p",  { id: "paragraph" }, null, "This is first React Application",
            ),
            React.createElement("button", { className: "btn btn-dark" }, null, "Click Me",
            ),
        ),
        React.createElement("section", { id: "article" }, null,
...
ReactDOM.render(MylandingPage, document.getElementById("root"));