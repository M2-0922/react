...
import { addTodo, deleteTodo, toggleTodo, updateTodo, editTodo, submitTodo } from "./actions/actions"
...
function App() {
  ...
  const handleSubmit = (id) => {
    const newText = inputRef2.current.value;
            ...
            <div key={todo.id}>
              <li className='todo'>
                ...
                { !todo.editable ?
                  ...
                  :
                  <>
                    <input type='text' defaultValue={todo.text} ref={inputRef2}/>
